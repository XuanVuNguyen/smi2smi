...
from smi2smi.transformer_ver_1 import build_model, InferenceModel
...
inference_config = {
    ...
    'model_dir':'model_checkpoints/Aug27_23h39_reproduce/',
    'epoch_number':200
}

data = {
    'test_source_dir':'data_wo_reaction_label/',
    'batch_size':64,
    'results_dir':'predictions_and_evaluation/USTPO-50'
}
